...
const stages = [
  ...
  { id: "complete", label: "Ready to chat", icon: Check },
]
...
export default function ProcessingPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#121212] text-[#F8F8F8] p-4 relative overflow-hidden">
      ...
      <div className="z-10 max-w-4xl w-full space-y-12">
        <div className="text-center mb-12">
          ...
          <p className="text-[#A0A0A0]">{repoUrl}</p>
        </div>
        ...
        <div className="bg-[#2D2D2D] rounded-lg border border-[#2D2D2D] p-4 font-code text-sm">
